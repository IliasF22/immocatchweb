...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Assistant IA à usage interne : note vocale WhatsApp → fiche structurée → rapprochement automatique des acheteurs, avec validation humaine. Pour les agences immobilières.",
    locale: "fr_FR",
    type: "website",
  },
};
