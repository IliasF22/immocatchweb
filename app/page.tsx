...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-900 pb-20 text-slate-100 sm:pb-0">
        ...
        <Reveal>
          <div className="mx-auto max-w-4xl px-5 py-20 text-center sm:py-28">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-300 sm:text-xl">
              ...
              mandat, les bons acheteurs de votre base remontent
              automatiquement.
            </p>
            ...
            <dl className="mx-auto mt-14 grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-3">
              {[
                {
                  value: "Vous dictez",
                  label: "un vocal en sortant de visite",
                  wa: true,
                },
                {
                  value: "L'IA structure",
                  label: "la fiche, complète et rangée",
                  wa: false,
                },
                {
                  value: "Vous validez",
                  label: "avant le moindre envoi",
                  wa: false,
                },
              ].map((pillar) => (
                <div
                  key={pillar.value}
                  className="rounded-md border border-slate-800 bg-slate-800 p-5 text-left transition-colors hover:border-slate-600"
                >
          ...
          <div className="mx-auto max-w-5xl px-5 py-20 sm:py-24">
            ...
            <div className="mt-14 grid gap-6 md:grid-cols-3">
              {[
                ...
                <div
                  key={item.title}
                  className="rounded-md border border-slate-800 bg-slate-800 p-7 transition-colors hover:border-slate-600"
                >
                  <span className="mb-5 flex h-11 w-11 items-center justify-center rounded-md bg-slate-900">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="#FF6B00"
      ...
      <section className="border-b border-slate-800">
        <Reveal>
          <div className="mx-auto max-w-5xl px-5 py-20 sm:py-24">
            ...
            <div className="mt-14 grid gap-6 md:grid-cols-3">
              {/* Option 1 */}
              <div className="rounded-md border border-slate-800 bg-slate-800 p-7 transition-colors hover:border-slate-600">
                ...
                <p className="mt-1 text-sm text-slate-400">
                  par an, soit 5 semaines
                </p>
                <p className="mt-4 leading-relaxed text-slate-300">
                  45 minutes de saisie par jour. Cinq semaines à taper au lieu
                  de vendre.
                </p>
              </div>
              ...
              <div className="rounded-md border border-slate-800 bg-slate-800 p-7 transition-colors hover:border-slate-600">
                ...
                <p className="mt-4 leading-relaxed text-slate-300">
                  À recruter, à former, à remplacer en congés. Et présent
              ...
              <div className="rounded-md border-2 border-[#FF6B00] bg-slate-800 p-7">
                ...
                <p className="mt-4 leading-relaxed text-slate-300">
                  Jour et nuit, sans contrat de travail. La fiche est écrite
                  avant que vous rentriez à l&apos;agence.
                </p>
              </div>
            </div>
      ...
      <section
        id="demo"
        className="bg-slate-950 border-b border-slate-800 scroll-mt-20"
      >
        <Reveal>
          <div className="mx-auto max-w-4xl px-5 py-20 sm:py-24">
            ...
            {!DEMO_FILE && !DEMO_EMBED_URL && (
              <p className="mx-auto mt-6 max-w-2xl text-center text-slate-300">
                La vidéo arrive. En attendant, je vous la fais en direct sur
                votre propre cas.
              </p>
            )}
          ...
          <div className="mx-auto max-w-6xl px-5 py-20 sm:py-24">
              ...
              {[
                {
                  name: "Module Fiches",
                  benefit:
                    "Un vocal suffit : la fiche est complète, propre et à jour.",
                  soon: false,
                  wa: true,
                },
                {
                  ...
                  benefit:
                    "Nouveau mandat, acheteurs compatibles et brouillons prêts à envoyer.",
                  soon: false,
                  wa: true,
                },
                {
                  ...
                  benefit:
                    "Rappels au bon moment : vous ne laissez plus refroidir un acheteur chaud.",
                  soon: false,
                  wa: true,
                },
                {
                  name: "Module Accueil",
                  benefit:
                    "Pré-qualification des leads entrants, pour les indépendants débordés.",
                  soon: true,
                  wa: true,
                },
                {
                  name: "Module Photos",
                  benefit:
                    "Les caractéristiques « coup de cœur » extraites des photos : moulures, cheminée, luminosité.",
                  soon: true,
                  wa: false,
                },
              ].map((mod) => (
                <div
                  key={mod.name}
                  className="flex flex-col rounded-md border border-slate-800 bg-slate-800 p-7 transition-colors hover:border-slate-600"
                >
            ...
            <div className="mx-auto mt-12 max-w-2xl rounded-md border border-slate-700 bg-slate-800 p-8 text-center">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Installation : paramétrage, reprise de votre base et prise en
                main.
              </p>
              <a
                href={PHONE_HREF}
          ...
          <div className="mx-auto max-w-3xl px-5 py-20 sm:py-24">
            ...
            <div className="mt-12 space-y-4">
              {[
                ...
                <details
                  key={item.q}
                  className="group rounded-md border border-slate-800 bg-slate-800 p-6 transition-colors hover:border-slate-600"
                >
        ...
        <Reveal>
          <div className="mx-auto max-w-4xl px-5 py-20 sm:py-24">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-700">
              ...
              de plateforme américaine, pas de support anonyme : vous avez une
              ligne directe, et je m&apos;occupe de tout le setup technique.
            </p>
